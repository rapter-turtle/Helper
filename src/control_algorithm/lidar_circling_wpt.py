...
########################################################################
    ...
    def control_time(self,msg):
        ...
        ########################################################################## circling control ##########################################################################
                self.distance_e = math.sqrt(self.rel_x*self.rel_x + self.rel_y*self.rel_y) - self.r
                ...
                if self.distance < 50:
                    ...
                    self.U_angle = self.an_Kp*self.theta + self.an_Kd*(self.theta - self.theta_before)*10
        ...
        #################################################################################################################################################################
                ...
                print("#########################################################################################################")
                print("rel x : ", self.rel_x, ", rel y : ", self.rel_y, ", rel yaw :", self.rel_yaw)     
